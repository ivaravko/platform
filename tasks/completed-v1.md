# Completed: gcp-components C1–C8 and runway-cli Tasks 1–5
...
[tasks/gcp-components-plan.md](gcp-components-plan.md). Spec: [SPEC-secure-container-service.md](../SPEC-secure-container-service.md).
...
[tasks/plan.md](gcp-components-plan.md#toolchain-findings-verified-not-assumed) records what was verified in
...
- [x] `@pulumi/pulumi` and `@pulumi/gcp` are pinned **exactly** (no caret) per
      [SPEC.md](../SPEC.md#boundaries). **[plan OQ4](gcp-components-plan.md#open-questions) resolved: `9.35.1`** —
...
- [ ] **Decide [plan OQ4](gcp-components-plan.md#open-questions)** — `@pulumi/gcp` 9.35.0 or 9.35.1 — and update
...
- **[plan OQ2](gcp-components-plan.md#open-questions) is now concrete and still unanswered.** `runway-public` is
...
- [x] **[plan OQ2](gcp-components-plan.md#open-questions) resolved** — C7's rules key on intrinsic facts
...
- [x] **No rule keys on the `runway-public` label** ([plan OQ2](gcp-components-plan.md#open-questions), resolved).
...
- [x] The pack is **precompiled JS** and its `Pulumi.yaml` (or equivalent) sets
      ...
      will not run at all ([plan finding 5](gcp-components-plan.md#toolchain-findings-verified-not-assumed))
...
[tasks/plan.md](runway-cli-prototype-plan.md).
